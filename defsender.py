...
window.title("DefSender")
window.geometry("720x480")




subject_field = customtkinter.CTkEntry(window, placeholder_text="")
...
friend_name = customtkinter.CTkEntry(window, placeholder_text="")
...
button = customtkinter.CTkButton(master=window, image = button_image, fg_color="transparent", text="", width=35, height=35, command=config)
